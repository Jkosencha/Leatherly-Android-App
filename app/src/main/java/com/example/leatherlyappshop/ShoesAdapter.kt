...
import com.example.leatherlyappshop.ShoesActivity

class ShoesAdapter(
    private var productList3: List<Product>,
    private val addToCartClickListener: OnAddToCartClickListener
) : RecyclerView.Adapter<ShoesAdapter.ProductViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.product_shoes, parent, false)
        return ProductViewHolder(view)
    }

    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        val product = productList3[position]
